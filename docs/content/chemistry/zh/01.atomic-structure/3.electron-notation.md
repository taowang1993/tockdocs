...
| :----------------------- | :------------------------------------------ | :----------------------------------------- |
| 原子结构示意图           | 表示每个能层容纳的电子数                    | ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/3.30.webp){style="height:50px"} |
| 电子排布式               | 表示每个能级容纳的电子数                    | $\ce{1s^2 2s^2 2p^6 3s^2 3p^4}$            |
| 简化的电子排布式         | 前一周期稀有气体元素符号 $+$ 剩余电子排布式 | $\ce{[Ne] 3s^2 3p^4}$                      |
| 电子排布图（轨道表示式） | 表示每个原子轨道容纳的电子数                | ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/3.31.webp){style="height:50px"} |
