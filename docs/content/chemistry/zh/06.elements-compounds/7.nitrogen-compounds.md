...
2. 成因：主要是大气中的 $\ce{SO2}$ 和 $\ce{NO_x}$ 以及它们在大气中发生反应后的生成物溶于水形成的
   ...
   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.1.webp)
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.3.webp){style="zoom:33%"}
...
2. 碱性（唯一的碱性气体）
   ...
   - $\ce{NH_3 + H_2O \xrightleftharpoons{} NH_3*H_2O \xrightleftharpoons{} NH_4^+ + OH^-}$
     ...
     > ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.2.webp)
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.4.webp){style="zoom:33%"}
...
>
>   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.6.webp){style="zoom:50%"}
>
> - 要防止倒吸
>
>   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.5.webp){style="zoom:50%"}

> 其他实验方式
>
> ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/7.7.webp){style="zoom:33%"}
>
> | 反应物                  | 原理                                                                                                                               |
> | ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
