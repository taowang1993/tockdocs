...
3. **化学性质**
   ...
   **$SiO_2$ 是一种酸性氧化物**
   ...
   4. 与碱性盐反应
      ...
      - $\ce{SiO2 + CaCO3 \xlongequal{高温} CaSiO3 + CO2 ^}$（造渣反应，炼铁时加入CaCO3将原料中的SiO2转化为炉渣，提高炼铁效率）
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.1.webp){style="width:180px"}
...
- 向硅酸盐溶液中加入盐酸或通入 $\ce{CO2}$，可制得硅酸胶体（凝胶）或沉淀
  ...
  - $\ce{Na2SiO3 + CO2 + H2O \xlongequal{} Na2CO3 + H2SiO3 v}$
    ...
    >
    > ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.2.webp){style="zoom:25%"}
    >
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.3.webp){style="zoom:50%"}
