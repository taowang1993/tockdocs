...
2. 苯和溴在 $\ce{FeBr3}$ 催化下可以发生反应，生成溴苯
   ...
   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.13.svg){style="zoom:70%"}
...
3. **在光照条件下**，甲苯与氯气发生取代反应时，氯原子取代甲基上的氢原子。反应后可能的有机产物是甲基上的氢原子分别被 $1$ 个、$2$ 个或 $3$ 个氯原子取代所生成的氯甲基苯
   ...
   **在 $\ce{FeBr3}$ 的催化下**，甲苯与氯发生取代反应生成的一氯代甲苯主要有两种：邻氯甲苯和对氯甲苯
   ...
   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.19.svg){style="zoom:20%"}

4. 苯酚稀溶液的试管里逐滴加入过量饱和的溴水，产生白色沉淀

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.13.svg){style="zoom:60%"}
...
![img](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.14.webp){style="zoom:50%"}

2. 甲苯与浓硝酸和浓硫酸的混合物在加热条件下可以发生取代反应，生成一硝基取代物、二硝基取代物和三硝基取代物，硝基取代的位置均以甲基的邻、对位为主

![image-20230429111425499](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.18.svg){style="zoom:18%"}

### 磺化

苯与浓硫酸在 $70-80\ce{°\!C}$ 可以发生磺化反应，生成苯磺酸苯与浓硫酸在 $70-80\ce{°\!C}$ 可以发生磺化反应，生成苯磺酸

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.15.webp){style="zoom:25%"}

### 醇分子间脱水成醚

如果把乙醇与浓硫酸的混合物的温度控制在 $140\ce{°C}$ 左右，每两个乙醇分子间会脱去一个水分子而生成乙醚

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.2.svg){style="zoom:25%"}

### 酯化

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.1.svg){style="zoom:25%"}

> 口诀：酸脱羟基醇脱氢

### 合成酰胺

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.26.svg){style="zoom:25%"}
...
2. 油脂
   ...
   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.29.svg)
   2. **碱性水解**：油脂在碱性溶液(如 $\ce{KOH}$ 或 $\ce{NaOH}$ 溶液)中水解，生成甘油和高级脂肪酸盐。高级脂肪酸盐常用于生产肥皂，所以油脂在碱性溶液中水解反应又称 **皂化反应**

   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.30.svg)
...
6. $1,2-$ 加成（低温）：$\ce{CH2=CH-CH=CH2 +Br2 ->}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.7.svg)

   $1,4-$ 加成（高温）：$\ce{CH2=CH-CH=CH2 +Br2 ->}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.8.svg)
...
![img](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.16.webp){style="zoom:50%"}

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.21.webp){style="zoom:25%"}
...
2. ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/K-1.1.svg){style="zoom:35%"}
3. $\ce{CH3-CO-CH3 +H2->[催化剂][\Delta]CH3-CHOH-CH3}$

### 油脂的氢化或硬化

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.31.webp){style="zoom:33%"}
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.36.svg){style="zoom:75%"}

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.37.svg){style="zoom:25%"}

### 羟基酸缩聚

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/K-1.3.svg){style="zoom:30%"}

### 醇酸缩聚

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/K-1.4.svg){style="zoom:30%"}

### 氨基酸缩聚

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/K-1.5.svg){style="zoom:30%"}

![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/K-1.6.svg){style="zoom:30%"}
