...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.14.svg)
...
2. 醛与 $\ce{HCN}$ 的加成反应：醛中的不饱和键与 $\ce{HCN}$ 发生加成反应生成含有氰基的物质，再经催化加氢还原成胺
   ...
   ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.2.svg){style="height:100px"}
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/5.19.svg){style="zoom:20%"}
...
反应示例：![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.1.svg){style="width:450px"}
...
![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.3.svg){style="zoom:90%"}
...
$\ce{PhH +}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.4.svg) $\ce{->[(1)AlCl3][(2)H2O]}\ce{Ph-CH2CH2OH}$
...
如：![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.5.svg){style="width:300px"}
...
如：$\ce{HOCH2CH2OH->[浓硫酸][\Delta]}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.4.svg) $\ce{+H2O}$

#### 二元羧酸成环

如：$\ce{HOOCCH2CH2COOH->[浓硫酸][\Delta]}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.6.svg) $\ce{+H2O}$

#### 氨基酸成环

如：$\ce{H2NCH2CH2COOH->[浓硫酸][\Delta]}$ ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.7.svg) $\ce{+H2O}$
...
| 反应                            | 示例                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 烃、酚的取代                    | ①甲烷在光照条件下的氯代 <br/> $\ce{CH4 + Cl2 ->[光] CH3Cl + HCl}$<br>②苯与溴苯在 $\ce{Fe}$ 粉 或 $\ce{FeBr3}$ 催化下生成溴苯 <br/> ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.13.svg){style="zoom:80%"} <br/> ③甲苯的卤代 <br/> ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/4.19.svg){style="zoom:20%"} <br/> ④苯酚与溴水反应生成三溴苯酚 <br/> ![](/04 有机化学基础/images/5.13.svg){style="zoom:60%"} |
...
| 碳碳双键氧化             | ![](/04 有机化学基础/images/9.8.svg)                   |
...
| 酯、酰胺键的水解                                     | ![](/04 有机化学基础/images/9.9.svg)                                                                                                                                                                                                                                                 |
| 某些苯环侧链上的烷基与<br>酸性高锰酸钾溶液的氧化反应 | ![](/04 有机化学基础/images/9.10.svg)                                                                                                                                                                                                                                                |
...
| 酰基化反应 | ![](/04 有机化学基础/images/9.11.svg)             |
...
#### ![](https://ptg90phsi6rf8j7h.public.blob.vercel-storage.com/chemistry/9.12.webp){style="zoom:50%"}
