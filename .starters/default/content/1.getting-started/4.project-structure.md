...
description: Learn about the project structure of TockDocs v4.
navigation:
...
TockDocs is a **Nuxt layer** that extends your standard Nuxt application with documentation features. This gives you the flexibility of a full Nuxt project.

When you create a new TockDocs project with `npx create-tockdocs my-docs`, you get:
...
This is where you write pages in Markdown. TockDocs automatically generates routes based on your file structure.
...
::tip
You can separate your documentation files within a `docs/` subfolder to make them accessible at the `/docs` route. Additionally, you have the flexibility to override your landing page using custom Vue pages if desired. Learn more in the [edition documentation](https://tockdocs.dev/concepts/edition).
::
...
a TockDocs application is really minimal and looks like:
...
_This file is not mandatory to start a TockDocs application._
...
This is where you can configure TockDocs to fit your branding, handle SEO, set your locale, and adapt links and socials. See the [configuration documentation](https://tockdocs.dev/concepts/configuration) for details.
...
Since TockDocs is a Nuxt layer, you can use **any feature** of a standard Nuxt project:
