...
**TockDocs et Nuxt UI** fournissent un ensemble de composants prose stylés et élégants pour vous aider à rédiger votre documentation avec la [syntaxe MDC](https://content.nuxt.com/docs/files/markdown#mdc-syntax).
...
::tabs
  :::tabs-item{icon="i-lucide-eye" label="Aperçu"}
    ::::accordion
      ...
      label: Qu'est-ce que TockDocs et quelles sont ses fonctionnalités clés ?
      ---
      TockDocs est une solution de documentation entièrement intégrée construite avec Nuxt UI. C'est un thème inspiré du template de documentation Nuxt UI qui fournit un visuel prêt à l'emploi. L'utilisateur peut se concentrer sur le contenu en utilisant Markdown et la syntaxe MDC.
      :::::

      :::::accordion-item
      ---
      icon: i-lucide-circle-help
      label: Comment démarrer avec TockDocs ?
      ---
      La seule chose dont vous avez besoin pour démarrer un projet TockDocs est un dossier `content/`. Consultez le starter pour un démarrage rapide.
      :::::
  ...
  :::accordion-item{label="Qu'est-ce que TockDocs et quelles sont ses fonctionnalités clés ?" icon="i-lucide-circle-help"}
  TockDocs est une solution de documentation entièrement intégrée construite avec Nuxt UI. C'est un thème inspiré du template de documentation Nuxt UI qui fournit un visuel prêt à l'emploi. L'utilisateur peut se concentrer sur le contenu en utilisant Markdown et la syntaxe MDC.
  :::

  :::accordion-item{label="Comment démarrer avec TockDocs ?" icon="i-lucide-circle-help"}
  La seule chose dont vous avez besoin pour démarrer un projet TockDocs est un dossier `content/`. Consultez le starter pour un démarrage rapide.
  :::
